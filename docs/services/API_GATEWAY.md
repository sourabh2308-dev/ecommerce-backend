...
| `X-Internal-Secret` | Environment variable | `veryStrongInternalSecret123` | Service-to-service auth |
...
- **Order:** Runs after authentication
- **Action:** Token-bucket rate limiting per client IP using Bucket4j
...
The gateway uses **Bucket4j** for in-memory token-bucket rate limiting:

- **Key:** Client IP address
- **Algorithm:** Token bucket — tokens are replenished at a fixed rate
...
<!-- 📸 Postman Screenshot: ![Gateway Health](../screenshots/gateway_health.png) -->
